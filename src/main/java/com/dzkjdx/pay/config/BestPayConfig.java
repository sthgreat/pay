...
public class BestPayConfig {
    ...
    @Bean
    //项目启动时加载该方法，启动配置，返回bestPayService对象
    public BestPayService bestPayService(){
        WxPayConfig wxPayConfig = new WxPayConfig();
        wxPayConfig.setAppId("wxd898fcb01713c658");
        wxPayConfig.setMchId("1483469312");
        wxPayConfig.setMchKey("098F6BCD4621D373CADE4E832627B4F6");
        wxPayConfig.setNotifyUrl("http://dzkjdx-mall.nat300.top/pay/notify");
        ...
        aliPayConfig.setNotifyUrl("http://dzkjdx-mall.nat300.top/pay/notify");
